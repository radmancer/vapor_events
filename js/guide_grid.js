    ...
    if(firstRowHeight == 0){
        ...
        for(var i = 1; i < 6; i++){
            var grid =  "display:-ms-grid;";
                grid += "display:grid;";
                grid += "-ms-grid-rows:30vh 14vh " + firstRowHeight + "vh 14vh 14vh 14vh " + lastRowHeight + "vh;";
                grid += "-ms-grid-columns:25vw 25vw 25vw 25vw 25vw;";
                grid += "grid-template:";
                grid += "'1_1   1_2   1_3   1_4   1_5' 30vh";
                grid += "'2_1   2_2   2_3   2_4   2_5' 14vh";
                grid += "'3_1   3_2   3_3   3_4   3_5' " + firstRowHeight + "vh";
            ...
            document.getElementsByClassName("cell-3_" + i)[0].style.height = firstRowHeight + "vh";
